...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Global 	GAME_TITLE$			=	"Project Salute Beta"
...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Function Game_LoadConfig()
		...
		If (xmlErrorCount()>0) Then RuntimeError("Config File Loading Error")
	...
	Function Game_LoadConfig_Input_Bind(Node_Root)
		...
		Select Lower$(Node_Action$)
			...
			Case "actionc"			: Action = INPUT_BUTTON_ACTION_C
			Case "interact"			: Action = INPUT_BUTTON_INTERACT
			Case "hover"			: Action = INPUT_BUTTON_HOVER
			Case "copypos"			: Action = INPUT_BUTTON_COPYPOS
			Case "copyrot"			: Action = INPUT_BUTTON_COPYROT
			Case "copygenericpos"	: Action = INPUT_BUTTON_COPYDEST
			Case "walk"				: Action = INPUT_BUTTON_WALK
