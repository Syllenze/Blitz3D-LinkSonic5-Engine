...
Const MAX_ATTRIBUTES = 1024	;The maximum number of attributes a xmlNode may have
Const MAX_ERRORS = 1024		;The maximum number of errors and warnings that will be processed until the xml parser aborts the operation
Const PARSER_RECURSE = 2048 ;The maximum number of virtually "recursive" steps for the parser.
